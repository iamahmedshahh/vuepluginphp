...
function admin_enqueue() {
    ...
    wp_enqueue_script('adminscript', plugins_url('/verusapi/dist/assets/index-da85dad1.js', __FILE__), array(), null, true);
    wp_enqueue_style('adminstyle', plugins_url('/verusapi/dist/assets/index-37970cf5.css', __FILE__));
}

function enqueue_vue_script() {

    wp_enqueue_script('fontendscript', plugins_url('/verusapi/dist/assets/index-da85dad1.js', __FILE__), array(), null, true);
